...
public class ObjectStringConverter
{
	...
	public ObjectStringConverter(ClassLoader classLoader)
	{
	...
	@SuppressWarnings("unchecked")
	public <T> T toObject(String string)
	{
		...
		String valuePart = string.substring(index + 1);
		if (converter instanceof SerializableConverter) {
			return (T)SerializableConverter.fromString(valuePart, classLoader);
		}
		else {
			return converter.fromString(valuePart);
		}
	}
	...
	*/
	...
	private static class SerializableConverter implements Converter<Serializable>
	{
		...
		{
			return Base64Util.encode(SerializationUtil.serialize(object));
		}

		@Override
		public Serializable fromString(String string)
		{
			return SerializationUtil.deserialize(Base64Util.decode(string));
		}

		public static Serializable fromString(String string, ClassLoader loader)
		{
			return SerializationUtil.deserialize(Base64Util.decode(string), loader);
		}
	}
}
